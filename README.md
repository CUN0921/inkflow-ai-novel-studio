...
面向个人长篇小说创作的本地 AI 写作工作台。

墨流把全书主线、分卷目标、近期章纲、章节正文、人物状态、已发生事实和伏笔分别管理，再按照章节逐步完成规划、写作、审稿与记忆更新。它适合 30 万字以上的长篇小说和持续连载，也允许作者随时修改章纲、重写单章或接管正文。

> 当前版本：`0.1.0`。项目优先支持 Windows，本地运行，不需要安装第三方 npm 依赖。
